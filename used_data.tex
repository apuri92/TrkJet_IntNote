...
The run dependence of the underlying event (a core part of this measurement) was tested by dividing the data and MC into three periods with approximately equal number of events in each period: 286711 -- 287259, 287270 -- 287632, and 287706 -- 287931. This was done because the underlying event estimation procedure was limited with the reduced statistics when looking at each individual run. The stability of the underlying event is shown in Fig.\ref{fig:weighted_runs}.
